...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: $0 --input_file <path> --dataset <dataset_name> [options]"
            echo "Options:"
            echo "  --subset <size>           Subset size used for original dataset"
...
# Build the command
CMD="python -m src.pipeline_dpo.split_collected_data_by_original \"$INPUT_FILE\" \"$DATASET_NAME\""
