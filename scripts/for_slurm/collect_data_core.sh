#!/bin/bash
#
# Core Data Collection Script for ConstLLM
# This script contains the core logic for data collection process
#
...
function show_help {
    ...
    echo ""
    echo "Example:"
    echo "  $0 --model meta-llama/Meta-Llama-3.1-8B-Instruct --dataset ecqa --wandb --gpu 1"
    exit 0
}
